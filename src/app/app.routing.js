System.register(["@angular/router", "./components/pages/linguist.component", "./components/component/textevaluation.component", "./components/pages/learner.component", "./components/pages/home.component", "./components/component/diagnostic.component", "./components/pages/test.component", "./components/pages/hitex.component", "./components/component/profileDetails.component", "./components/pages/profile.component", "./components/intern/exercisetype.component", "./components/component/hangbird.component", "./components/pages/register.component", "./components/pages/editor.component", "./components/component/cedit.form.component", "./components/intern/hangbird.eesti.component", "./components/intern/diagnostic.demo.component", "./components/component/liwrix.component", "./components/component/hangbird.image.component", "./components/intern/siwoco.component"], function (exports_1, context_1) {
    ...
    var router_1, linguist_component_1, textevaluation_component_1, learner_component_1, home_component_1, diagnostic_component_1, test_component_1, hitex_component_1, profileDetails_component_1, profile_component_1, exercisetype_component_1, hangbird_component_1, register_component_1, editor_component_1, cedit_form_component_1, hangbird_eesti_component_1, diagnostic_demo_component_1, liwrix_component_1, hangbird_image_component_1, siwoco_component_1, appRoutes, appRoutingProviders, routing;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
