    ...
    return {
        ...
        execute: function() {
            ProfileOverviewComponent = (function () {
                ...
                ProfileOverviewComponent.prototype.canActivate = function (route, state) {
                    return this.login.getUserId() == this.profileId;
                };
                ProfileOverviewComponent.prototype.loadInfo = function (id) {
                    // connect to DB
                    // -> defer call to model service
                    this.profileId = id;
                    console.log("Loading user " + id);
                };
                ProfileOverviewComponent.prototype.getId = function () {
                    if (!this.profileId) {
