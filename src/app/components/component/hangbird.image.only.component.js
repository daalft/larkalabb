    ...
    return {
        ...
        execute: function() {
            ...
            HangBirdImageComponent = (function () {
                ...
                HangBirdImageComponent.prototype.startGame = function () {
                    if (this.ongoing) {
                        this.endGame(2);
                    }
                    this.waiter.on();
                ...
                HangBirdImageComponent.prototype.setLanguage = function (event) {
                ...
                HangBirdImageComponent.prototype.setLevel = function (event) {
                    this.level = event.target.value;
                    //this.aggregator.aggregate("wordguess-level", this.level, this.sessionid);
                };
                HangBirdImageComponent.prototype.showTrans = function () {
                    this.showHint = true;
                    this.usedHint = true;
                    this.aggregator.addInformation("hint", "translation");
                };
                HangBirdImageComponent.prototype.getWordInformation = function (word, pos) {
                    var me = this;
                ...
                HangBirdImageComponent.prototype.getBackupWord = function (reason) {
                    console.log("Using backup list");
                    console.log(reason);
                    return this.wordlistBackup[Math.floor(Math.random() * this.wordlistBackup.length)];
                };
                HangBirdImageComponent.prototype.tryLetter = function (letter) {
                ...
                HangBirdImageComponent.prototype.restartGame = function () {
                    this.images = [];
                    this.selectedArray = [];
                    this.startGame();
                    /*
                ...
                HangBirdImageComponent.prototype.selectImage = function (index) {
                    this.selectedArray[index] = !this.selectedArray[index];
                };
                HangBirdImageComponent.prototype.endGame = function (status) {
                    this.ongoing = false;
                    var gscore = 0;
                    if (status == 1) {
                        this.inARow++;
...
//# sourceMappingURL=hangbird.image.only.component.js.map